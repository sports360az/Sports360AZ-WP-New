...
if (!function_exists('lvca_get_vc_map_carousel_display_options')) {
...
if (!function_exists('lvca_get_vc_map_carousel_options')) {
...
if (!function_exists('lvca_get_default_atts_carousel')) {
