...
class LVCA_Services
{
    ...
    public function shortcode_func( $atts, $content = null, $tag )
    {
        ...
        <div id="lvca-services<?php 
        echo  uniqid() ;
        ?>" data-settings='<?php 
        echo  htmlspecialchars( json_encode( $settings ) ) ;
        ?>' class="lvca-services lvca-<?php 
        echo  $settings['style'] ;
        ?> lvca-grid-container <?php 
        echo  lvca_get_grid_classes( $settings ) ;
        ?>">
    ...
    public function child_shortcode_func( $atts, $content = null, $tag )
    {
            ...
            if ( !empty(${'icon_' . $icon_family}) ) {
                ?>
                        ...
                        <div class="lvca-icon-wrapper">
                            ...
                            <?php 
                echo  lvca_get_icon( ${'icon_' . $icon_family} ) ;
                ?>
        ...
        if ( !empty($content) ) {
            ?>
                        ...
                        <div class="lvca-service-details"><?php 
