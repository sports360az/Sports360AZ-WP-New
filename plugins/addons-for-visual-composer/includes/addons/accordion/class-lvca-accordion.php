...
class LVCA_Accordion
{
    ...
    public function shortcode_func( $atts, $content = null, $tag )
    {
        ...
        <div class="lvca-accordion lvca-<?php 
        echo  $style ;
        ?>"
             data-toggle="<?php 
    ...
    public function child_shortcode_func( $atts, $content = null, $tag )
    {
        ...
        if ( empty($panel_id) ) {
            $panel_id = sanitize_title_with_dashes( $panel_title );
        }
        ?>

        <div class="lvca-panel" id="<?php 
        echo  $panel_id ;
        ?>">

            <div class="lvca-panel-title"><?php 
        echo  esc_html( $panel_title ) ;
        ?></div>

            <div class="lvca-panel-content"><?php 
