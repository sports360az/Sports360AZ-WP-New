...
<form name="editgroup" id="post" method="post" action="admin.php?page=adrotate-groups">
	...
	<?php } ?>
   	...
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2">
				<label for="adrotate_groupname"><input tabindex="1" name="adrotate_groupname" type="text" class="search-input" size="50" value="<?php echo $edit_group->name; ?>" autocomplete="off" /> <em><?php _e('Visible to Advertisers!', 'adrotate'); ?></em></label>
			</td>
		</tr>
	    <tr>
	...
	<p><em><?php _e('Only required if your group is in Dynamic or Block mode.', 'adrotate'); ?></em></p>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			<th valign="top"><?php _e('Automatic refresh', 'adrotate'); ?></strong></th>
			<td>
   	...
   	<table class="widefat" style="margin-top: .5em">
	    <tr>
			...
			<td width="35%">
				...
				Bottom: <input tabindex="10" name="adrotate_admargin_bottom" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_bottom; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.<br />
				...
				Right: <input tabindex="12" name="adrotate_admargin_right" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_right; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.</label>
			</td>
			<td colspan="2">
		        <p><em><?php _e('A transparent area outside the advert in pixels. Default: 0/0/0/0.', 'adrotate'); ?> <?php _e('Set to 0 to disable.', 'adrotate'); ?> <?php _e('Margins are automatically disabled for blocks where required.', 'adrotate'); ?></em></p>
			</td>
		</tr>
	    <tr>
	    ...
	    <tr>
			...
			<td width="35%"><label for="adrotate_geo"><input tabindex="14" type="checkbox" name="adrotate_geo" value="1" <?php if($edit_group->geo == '1') { ?>checked="checked"<?php } ?> /> <?php _e('Enable Geo Targeting for this group.', 'adrotate'); ?></label></td>
			<td><p><em><?php _e('Do not forget to set up Geo Targeting for your adverts as well.', 'adrotate'); ?></em></p></td>
		</tr>
		<?php } ?>
	    <tr>
			<th width="15%" valign="top"><?php _e('Mobile support', 'adrotate'); ?></th>
			<td width="35%"><label for="adrotate_mobile"><input tabindex="15" type="checkbox" name="adrotate_mobile" value="1" <?php if($edit_group->mobile == '1') { ?>checked="checked"<?php } ?> /> <?php _e('Enable mobile support for this group.', 'adrotate'); ?></label></td>
			<td><p><em><?php _e('Do not forget to put at least one mobile advert in this group or no adverts will show on mobile devices.', 'adrotate'); ?></em></p></td>
		</tr>
	    <tr>
	        ...
	        <td><em><?php _e('Select another group to fall back on when all ads are expired, not in the visitors geographic area or are otherwise unavailable.', 'adrotate'); ?><br /><strong><?php _e('Note:', 'adrotate'); ?></strong> <?php _e('If you use a multisite/networked setup you can not select groups from other sites here. Use the override in the shortcode or PHP snippet instead!', 'adrotate'); ?></em></td>
		</tr>
      	<tr>
	...
	<p class="submit">
		<input tabindex="21" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
		<a href="admin.php?page=adrotate-groups&view=manage" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>
	...
	<p class="submit">
		<input tabindex="24" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
		<a href="admin.php?page=adrotate-groups&view=manage" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>
