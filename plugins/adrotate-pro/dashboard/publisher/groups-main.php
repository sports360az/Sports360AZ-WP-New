   	...
   	<table class="widefat" style="margin-top: .5em">
		...
		if($groups) {
			...
			foreach($groups as $group) {
		        ...
		        if($group->mobile == 1) $modus[] = __('Mobile', 'adrotate');
