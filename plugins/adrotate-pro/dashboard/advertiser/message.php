...
<form name="request" id="post" method="post" action="admin.php?page=adrotate-advertiser">
	...
	<h3><?php _e('Contact your Publisher', 'adrotate'); ?></h3>
	<p><em><?php _e('Put in a request for renewal, removal or report an issue with this ad.', 'adrotate'); ?></em></p>
	...
	<p class="submit">
		...
		<a href="admin.php?page=adrotate-advertiser" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>
</form>