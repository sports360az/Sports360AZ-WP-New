...
<table class="form-table">			
	<tr>
		...
		<td>
			...
			<input type="checkbox" name="adrotate_debug_publisher" <?php if($adrotate_debug['publisher'] == true) { ?>checked="checked" <?php } ?> /> Publishers - <span class="description"><?php _e('View advert specs and (some) stats in the dashboard. Visible only to publishers.', 'adrotate'); ?></span><br />
			<input type="checkbox" name="adrotate_debug_advertiser" <?php if($adrotate_debug['advertiser'] == true) { ?>checked="checked" <?php } ?> /> Advertisers - <span class="description"><?php _e('View advert specs on the moderator queue. Output stats summary for Advertisers!', 'adrotate'); ?></span><br />
			<input type="checkbox" name="adrotate_debug_geo" <?php if($adrotate_debug['geo'] == true) { ?>checked="checked" <?php } ?> /> Geo Targeting - <span class="description"><?php _e('View Geo Targeting data on the Geo Targeting tab here in settings. Also has Geo Data output on the front-end.', 'adrotate'); ?></span><br />
			<input type="checkbox" name="adrotate_debug_timers" <?php if($adrotate_debug['timers'] == true) { ?>checked="checked" <?php } ?> /> Clicktracking - <span class="description"><?php _e('Disable timers for clicks and impressions and enable a alert window for clicktracking. AdRotate Internal Tracker only.', 'adrotate'); ?></span><br />
			<input type="checkbox" name="adrotate_debug_track" <?php if($adrotate_debug['track'] == true) { ?>checked="checked" <?php } ?> /> Tracking Encryption - <span class="description"><?php _e('Temporarily disable encryption on the redirect url. AdRotate Internal Tracker only.', 'adrotate'); ?></span><br />
		</td>
	</tr>
</table>
