	...
	<tr>
		...
		<td>
			<select name="adrotate_stats">
				...
				<option value="2" <?php if($adrotate_config['stats'] == 2) { echo 'selected'; } ?>>Piwik Analytics (Advanced, Faster)</option>
				<option value="3" <?php if($adrotate_config['stats'] == 3) { echo 'selected'; } ?>>Google Analytics (Faster)</option>
			</select><br />
...
<table class="form-table">
	<tr>
		...
		<td>
			<input type="checkbox" name="adrotate_enable_loggedin_impressions" <?php if($adrotate_config['enable_loggedin_impressions'] == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Track impressions from logged in users.', 'adrotate'); ?>
		</td>
	</tr>
	<tr>
		<th valign="top"><?php _e('Logged in clicks', 'adrotate'); ?></th>
		<td>
			<input type="checkbox" name="adrotate_enable_loggedin_clicks" <?php if($adrotate_config['enable_loggedin_clicks'] == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Track clicks from logged in users.', 'adrotate'); ?>
		</td>
	</tr>
	<tr>
